...
public class UtilisateurServiceImpl implements UtilisateurService {
    ...
    public UtilisateurDto updateUtilisateur(UtilisateurDto utilisateurDto) {
    	...
    	/*existingUtilisateur.setTel(utilisateurDto.getTel());
    	ProfilEntity profilEntity = modelMapper.map(utilisateurDto.getProfil(), ProfilEntity.class);
    	existingUtilisateur.setProfil(profilEntity);*/
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		if(utilisateurEntity == null) throw new UsernameNotFoundException(login);
	...
	public UtilisateurDto findUtilisateurByUtilisateurId(String utilisateurId) {
		...
		if(userEntity == null) throw new UsernameNotFoundException(utilisateurId);
		UtilisateurDto userDto = new UtilisateurDto();
